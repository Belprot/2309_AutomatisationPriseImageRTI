...
{   
    ...
    /*Set period */ 
    PLIB_TMR_Period16BitSet(TMR_ID_2, 3999);
    /* Setup Interrupt */   
...
{   
    ...
    /* Setup Interrupt */   
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_T3, INT_PRIORITY_LEVEL4);
...
{   
    ...
    /*Set period */ 
    PLIB_TMR_Period16BitSet(TMR_ID_4, 39999);
    /* Setup Interrupt */   
...
{   
    ...
    /*Set period */ 
    PLIB_TMR_Period16BitSet(TMR_ID_5, 39999);
    /* Setup Interrupt */   
