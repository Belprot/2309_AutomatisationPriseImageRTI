...
PLIB_MCPWM_PrimaryTimerSetup (MCPWM_ID_0 , MCPWM_CLOCK_DIVIDE_BY_1 , 200);
...
/* MCPWM Channel instance MCPWM_CHANNEL1 */
	...
	MCPWM_OUTPUT_COMPLIMENTARY_MODE, MCPWM_PWMxH_ACTIVELOW ,MCPWM_PWMxL_ACTIVEHIGH , MCPWM_DEADTIME_POSITIVE, MCPWM_DEADTIME_COMPENSATION_POLARITY_ACTIVE_HIGH );
...
/* MCPWM Channel instance MCPWM_CHANNEL2 */
	...
	MCPWM_OUTPUT_COMPLIMENTARY_MODE, MCPWM_PWMxH_ACTIVEHIGH ,MCPWM_PWMxL_ACTIVELOW , MCPWM_DEADTIME_POSITIVE, MCPWM_DEADTIME_COMPENSATION_POLARITY_ACTIVE_HIGH );
