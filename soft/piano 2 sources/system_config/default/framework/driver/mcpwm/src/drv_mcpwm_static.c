...
PLIB_MCPWM_PrimaryTimerSetup (MCPWM_ID_0 , MCPWM_CLOCK_DIVIDE_BY_1 , 1200);
...
/* MCPWM Channel instance MCPWM_CHANNEL7 */
	...
	MCPWM_OUTPUT_COMPLIMENTARY_MODE, MCPWM_PWMxH_ACTIVEHIGH ,MCPWM_PWMxL_ACTIVEHIGH , MCPWM_DEADTIME_DISABLE, MCPWM_DEADTIME_COMPENSATION_POLARITY_ACTIVE_HIGH );
...
/* MCPWM Channel instance MCPWM_CHANNEL1 */
	...
	PLIB_MCPWM_ChannelPhaseSet (MCPWM_ID_0 , MCPWM_CHANNEL1 , 99);
...
/* MCPWM Channel instance MCPWM_CHANNEL10 */
	...
	PLIB_MCPWM_ChannelPhaseSet (MCPWM_ID_0 , MCPWM_CHANNEL10 , 199);
...
/* MCPWM Channel instance MCPWM_CHANNEL4 */
	...
	PLIB_MCPWM_ChannelPhaseSet (MCPWM_ID_0 , MCPWM_CHANNEL4 , 299);
...
/* MCPWM Channel instance MCPWM_CHANNEL8 */
	...
	PLIB_MCPWM_ChannelPhaseSet (MCPWM_ID_0 , MCPWM_CHANNEL8 , 399);
...
/* MCPWM Channel instance MCPWM_CHANNEL2 */
	...
	PLIB_MCPWM_ChannelPhaseSet (MCPWM_ID_0 , MCPWM_CHANNEL2 , 499);
...
/* MCPWM Channel instance MCPWM_CHANNEL9 */
	...
	PLIB_MCPWM_ChannelPhaseSet (MCPWM_ID_0 , MCPWM_CHANNEL9 , 599);
...
/* MCPWM Channel instance MCPWM_CHANNEL3 */
	...
	PLIB_MCPWM_ChannelPhaseSet (MCPWM_ID_0 , MCPWM_CHANNEL3 , 699);
...
// *****************************************************************************
/* MCPWM Channel instance MCPWM_CHANNEL11 */
	PLIB_MCPWM_ChannelSetup (MCPWM_ID_0 , MCPWM_CHANNEL11, MCPWM_TIME_BASE_SOURCE_PRIMARY , MCPWM_TIME_BASE_SYNCHRONIZED , MCPWM_EDGE_ALIGNED,
	MCPWM_OUTPUT_COMPLIMENTARY_MODE, MCPWM_PWMxH_ACTIVEHIGH ,MCPWM_PWMxL_ACTIVEHIGH , MCPWM_DEADTIME_DISABLE, MCPWM_DEADTIME_COMPENSATION_POLARITY_ACTIVE_HIGH );
	
	PLIB_MCPWM_ChannelPrimaryDutyCycleSet (MCPWM_ID_0 , MCPWM_CHANNEL11 , 0);
	PLIB_MCPWM_ChannelSecondaryDutyCycleSet (MCPWM_ID_0 , MCPWM_CHANNEL11 , 0);
	PLIB_MCPWM_ChannelPWMxHDeadtimeSet (MCPWM_ID_0 , MCPWM_CHANNEL11 , 0);
	PLIB_MCPWM_ChannelPWMxLDeadtimeSet (MCPWM_ID_0 , MCPWM_CHANNEL11 , 0);
	PLIB_MCPWM_ChannelDeadtimeCompSet (MCPWM_ID_0 , MCPWM_CHANNEL11 , 0);
	PLIB_MCPWM_ChannelPhaseSet (MCPWM_ID_0 , MCPWM_CHANNEL11 , 799);
	
	
	PLIB_MCPWM_ChannelTriggerSetup (MCPWM_ID_0 , MCPWM_CHANNEL11 , MCPWM_TRIGGER_DIVIDE_BY_1, 
	MCPWM_PRIMARY_TRIGGER_DURING_TIMER_INCREMENTING_DECREMENTING , MCPWM_SECONDARY_TRIGGER_DURING_TIMER_INCREMENTING_DECREMENTING , MCPWM_ADC_TRIGGER_SOURCE_PRIMARY,
	MCPWM_TRIGGER_INTERRUPT_SOURCE_PRIMARY, 0 , 0);
	

	PLIB_MCPWM_ChannelLEBSetup (MCPWM_ID_0 , MCPWM_CHANNEL11 , MCPWM_FAULT_INPUT_LEB_DISABLE, MCPWM_CURRENTLIMIT_INPUT_LEB_DISABLE, 
	0);	
	...
	PLIB_MCPWM_ChannelChopSetup (MCPWM_ID_0 , MCPWM_CHANNEL11 , MCPWM_CHOP_CLOCK_SOURCE_IS_CHOP_CLOCK_GENERATOR, MCPWM_PWMxH_CHOP_DISABLED, MCPWM_PWMxL_CHOP_DISABLED);
	
	
	PLIB_MCPWM_ChannelFaultSetup (MCPWM_ID_0 , MCPWM_CHANNEL11, MCPWM_FAULT_SOURCE_IS_FLT15 , MCPWM_FAULT_INPUT_POLARITY_ACTIVE_HIGH,
	MCPWM_FAULT_OVERRIDE_PWMxH_0, MCPWM_FAULT_OVERRIDE_PWMxL_0, MCPWM_FAULT_MODE_DISABLED);
	
	
	PLIB_MCPWM_ChannelCurrentLimitSetup (MCPWM_ID_0 , MCPWM_CHANNEL11, MCPWM_CURRENTLIMIT_SOURCE_IS_FLT15 , MCPWM_CURRENTLIMIT_INPUT_POLARITY_ACTIVE_HIGH,
	MCPWM_CURRENTLIMIT_OVERRIDE_PWMxH_0,MCPWM_CURRENTLIMIT_OVERRIDE_PWMxL_0, MCPWM_CURRENTLIMIT_DISABLE );
	
	
	PLIB_MCPWM_ChannelOverrideOutputSet (MCPWM_ID_0 , MCPWM_CHANNEL11, MCPWM_OVERRIDE_PWMxH_0, MCPWM_OVERRIDE_PWMxL_0);
	
	
	
	PLIB_MCPWM_ChannelPWMxHEnable (MCPWM_ID_0 ,MCPWM_CHANNEL11);
...
// *****************************************************************************
/* MCPWM Channel instance MCPWM_CHANNEL12 */
	PLIB_MCPWM_ChannelSetup (MCPWM_ID_0 , MCPWM_CHANNEL12, MCPWM_TIME_BASE_SOURCE_PRIMARY , MCPWM_TIME_BASE_SYNCHRONIZED , MCPWM_EDGE_ALIGNED,
	MCPWM_OUTPUT_COMPLIMENTARY_MODE, MCPWM_PWMxH_ACTIVEHIGH ,MCPWM_PWMxL_ACTIVEHIGH , MCPWM_DEADTIME_DISABLE, MCPWM_DEADTIME_COMPENSATION_POLARITY_ACTIVE_HIGH );
	
	PLIB_MCPWM_ChannelPrimaryDutyCycleSet (MCPWM_ID_0 , MCPWM_CHANNEL12 , 0);
	PLIB_MCPWM_ChannelSecondaryDutyCycleSet (MCPWM_ID_0 , MCPWM_CHANNEL12 , 0);
	PLIB_MCPWM_ChannelPWMxHDeadtimeSet (MCPWM_ID_0 , MCPWM_CHANNEL12 , 0);
	PLIB_MCPWM_ChannelPWMxLDeadtimeSet (MCPWM_ID_0 , MCPWM_CHANNEL12 , 0);
	PLIB_MCPWM_ChannelDeadtimeCompSet (MCPWM_ID_0 , MCPWM_CHANNEL12 , 0);
	PLIB_MCPWM_ChannelPhaseSet (MCPWM_ID_0 , MCPWM_CHANNEL12 , 899);
	
	
	PLIB_MCPWM_ChannelTriggerSetup (MCPWM_ID_0 , MCPWM_CHANNEL12 , MCPWM_TRIGGER_DIVIDE_BY_1, 
	MCPWM_PRIMARY_TRIGGER_DURING_TIMER_INCREMENTING_DECREMENTING , MCPWM_SECONDARY_TRIGGER_DURING_TIMER_INCREMENTING_DECREMENTING , MCPWM_ADC_TRIGGER_SOURCE_PRIMARY,
	MCPWM_TRIGGER_INTERRUPT_SOURCE_PRIMARY, 0 , 0);
	

	PLIB_MCPWM_ChannelLEBSetup (MCPWM_ID_0 , MCPWM_CHANNEL12 , MCPWM_FAULT_INPUT_LEB_DISABLE, MCPWM_CURRENTLIMIT_INPUT_LEB_DISABLE, 
	0);	
	...
	PLIB_MCPWM_ChannelChopSetup (MCPWM_ID_0 , MCPWM_CHANNEL12 , MCPWM_CHOP_CLOCK_SOURCE_IS_CHOP_CLOCK_GENERATOR, MCPWM_PWMxH_CHOP_DISABLED, MCPWM_PWMxL_CHOP_DISABLED);
	
	
	PLIB_MCPWM_ChannelFaultSetup (MCPWM_ID_0 , MCPWM_CHANNEL12, MCPWM_FAULT_SOURCE_IS_FLT15 , MCPWM_FAULT_INPUT_POLARITY_ACTIVE_HIGH,
	MCPWM_FAULT_OVERRIDE_PWMxH_0, MCPWM_FAULT_OVERRIDE_PWMxL_0, MCPWM_FAULT_MODE_DISABLED);
	
	
	PLIB_MCPWM_ChannelCurrentLimitSetup (MCPWM_ID_0 , MCPWM_CHANNEL12, MCPWM_CURRENTLIMIT_SOURCE_IS_FLT15 , MCPWM_CURRENTLIMIT_INPUT_POLARITY_ACTIVE_HIGH,
	MCPWM_CURRENTLIMIT_OVERRIDE_PWMxH_0,MCPWM_CURRENTLIMIT_OVERRIDE_PWMxL_0, MCPWM_CURRENTLIMIT_DISABLE );
	
	
	PLIB_MCPWM_ChannelOverrideOutputSet (MCPWM_ID_0 , MCPWM_CHANNEL12, MCPWM_OVERRIDE_PWMxH_0, MCPWM_OVERRIDE_PWMxL_0);
	
	
	
	PLIB_MCPWM_ChannelPWMxHEnable (MCPWM_ID_0 ,MCPWM_CHANNEL12);
...
/* MCPWM Channel instance MCPWM_CHANNEL5 */
	PLIB_MCPWM_ChannelSetup (MCPWM_ID_0 , MCPWM_CHANNEL5, MCPWM_TIME_BASE_SOURCE_PRIMARY , MCPWM_TIME_BASE_SYNCHRONIZED , MCPWM_EDGE_ALIGNED,
	MCPWM_OUTPUT_COMPLIMENTARY_MODE, MCPWM_PWMxH_ACTIVEHIGH ,MCPWM_PWMxL_ACTIVEHIGH , MCPWM_DEADTIME_DISABLE, MCPWM_DEADTIME_COMPENSATION_POLARITY_ACTIVE_HIGH );
	...
	PLIB_MCPWM_ChannelPhaseSet (MCPWM_ID_0 , MCPWM_CHANNEL5 , 999);
	
	
	PLIB_MCPWM_ChannelTriggerSetup (MCPWM_ID_0 , MCPWM_CHANNEL5 , MCPWM_TRIGGER_DIVIDE_BY_1, 
	MCPWM_PRIMARY_TRIGGER_DURING_TIMER_INCREMENTING_DECREMENTING , MCPWM_SECONDARY_TRIGGER_DURING_TIMER_INCREMENTING_DECREMENTING , MCPWM_ADC_TRIGGER_SOURCE_PRIMARY,
	MCPWM_TRIGGER_INTERRUPT_SOURCE_PRIMARY, 0 , 0);
	

	PLIB_MCPWM_ChannelLEBSetup (MCPWM_ID_0 , MCPWM_CHANNEL5 , MCPWM_FAULT_INPUT_LEB_DISABLE, MCPWM_CURRENTLIMIT_INPUT_LEB_DISABLE, 
	0);	
	...
	PLIB_MCPWM_ChannelFaultSetup (MCPWM_ID_0 , MCPWM_CHANNEL5, MCPWM_FAULT_SOURCE_IS_FLT15 , MCPWM_FAULT_INPUT_POLARITY_ACTIVE_HIGH,
	MCPWM_FAULT_OVERRIDE_PWMxH_0, MCPWM_FAULT_OVERRIDE_PWMxL_0, MCPWM_FAULT_MODE_DISABLED);
...
/* MCPWM Channel instance MCPWM_CHANNEL6 */
	PLIB_MCPWM_ChannelSetup (MCPWM_ID_0 , MCPWM_CHANNEL6, MCPWM_TIME_BASE_SOURCE_PRIMARY , MCPWM_TIME_BASE_SYNCHRONIZED , MCPWM_EDGE_ALIGNED,
	MCPWM_OUTPUT_COMPLIMENTARY_MODE, MCPWM_PWMxH_ACTIVEHIGH ,MCPWM_PWMxL_ACTIVEHIGH , MCPWM_DEADTIME_DISABLE, MCPWM_DEADTIME_COMPENSATION_POLARITY_ACTIVE_HIGH );
	...
	PLIB_MCPWM_ChannelPhaseSet (MCPWM_ID_0 , MCPWM_CHANNEL6 , 1099);
