...
PLIB_MCPWM_PrimaryTimerSetup (MCPWM_ID_0 , MCPWM_CLOCK_DIVIDE_BY_8 , 50000);
...
/* MCPWM Channel instance MCPWM_CHANNEL1 */
	...
	PLIB_MCPWM_ChannelPrimaryDutyCycleSet (MCPWM_ID_0 , MCPWM_CHANNEL1 , 50000);
	PLIB_MCPWM_ChannelSecondaryDutyCycleSet (MCPWM_ID_0 , MCPWM_CHANNEL1 , 0);
	PLIB_MCPWM_ChannelPWMxHDeadtimeSet (MCPWM_ID_0 , MCPWM_CHANNEL1 , 2000);
	PLIB_MCPWM_ChannelPWMxLDeadtimeSet (MCPWM_ID_0 , MCPWM_CHANNEL1 , 2000);
...
/* MCPWM Channel instance MCPWM_CHANNEL2 */
	...
	PLIB_MCPWM_ChannelPrimaryDutyCycleSet (MCPWM_ID_0 , MCPWM_CHANNEL2 , 50000);
	PLIB_MCPWM_ChannelSecondaryDutyCycleSet (MCPWM_ID_0 , MCPWM_CHANNEL2 , 0);
	PLIB_MCPWM_ChannelPWMxHDeadtimeSet (MCPWM_ID_0 , MCPWM_CHANNEL2 , 2000);
	PLIB_MCPWM_ChannelPWMxLDeadtimeSet (MCPWM_ID_0 , MCPWM_CHANNEL2 , 2000);
	PLIB_MCPWM_ChannelDeadtimeCompSet (MCPWM_ID_0 , MCPWM_CHANNEL2 , 0);
	PLIB_MCPWM_ChannelPhaseSet (MCPWM_ID_0 , MCPWM_CHANNEL2 , 25000);
