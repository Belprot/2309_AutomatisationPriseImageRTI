...
PLIB_MCPWM_PrimaryTimerSetup (MCPWM_ID_0 , MCPWM_CLOCK_DIVIDE_BY_1 , 8000);
...
/* MCPWM Channel instance MCPWM_CHANNEL4 */
	PLIB_MCPWM_ChannelSetup (MCPWM_ID_0 , MCPWM_CHANNEL4, MCPWM_TIME_BASE_SOURCE_PRIMARY , MCPWM_TIME_BASE_INDEPENDENT , MCPWM_EDGE_ALIGNED,
	...
	PLIB_MCPWM_ChannelPrimaryDutyCycleSet (MCPWM_ID_0 , MCPWM_CHANNEL4 , 4000);
